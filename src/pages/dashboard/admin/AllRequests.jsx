              ...
              <div key={request._id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="p-6 border-b">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="font-bold text-lg text-gray-900">{request.recipientName}</h3>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <p className="font-bold text-red-600 text-lg">{request.bloodGroup}</p>
                    </div>
                    <div>
                ...
                <div className="p-6">
                  <div className="space-y-3">
                    <div className="flex items-center text-gray-600">
                      ...
                      <span className="text-sm">{formatDate(request.donationDate)} at {request.donationTime}</span>
                    </div>
                    
                    <div className="flex items-center text-gray-600">
                      <MapPin className="h-4 w-4 mr-2" />
                      <span className="text-sm">{request.recipientDistrict}, {request.recipientUpazila}</span>
                    </div>
